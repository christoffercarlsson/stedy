...
void stedy_rng_seed(stedy_rng_state *state);

void stedy_rng_reseed(stedy_rng_state *state);

void stedy_rng_from(const uint8_t seed[128], stedy_rng_state *state);
...
void stedy_blake2b512(const uint8_t *message, size_t message_size,
                      uint8_t digest[64]);
...
void stedy_blake2b384(const uint8_t *message, size_t message_size,
                      uint8_t digest[48]);
...
void stedy_blake2b256(const uint8_t *message, size_t message_size,
                      uint8_t digest[32]);
...
void stedy_blake2b160(const uint8_t *message, size_t message_size,
                      uint8_t digest[20]);
...
void stedy_blake2s256(const uint8_t *message, size_t message_size,
                      uint8_t digest[32]);
...
void stedy_blake2s224(const uint8_t *message, size_t message_size,
                      uint8_t digest[28]);
...
void stedy_blake2s160(const uint8_t *message, size_t message_size,
                      uint8_t digest[20]);
...
void stedy_blake2s128(const uint8_t *message, size_t message_size,
                      uint8_t digest[16]);
...
void stedy_chacha20poly1305_encrypt(const uint8_t key[32],
                                    ...
                                    size_t message_size, uint8_t tag[16]);
...
void stedy_ed25519_sign(const uint8_t private_key[32], const uint8_t *message,
                        size_t message_size, uint8_t signature[64]);

bool stedy_ed25519_verify(const uint8_t *message, size_t message_size,
...
void stedy_hkdf_sha512(const uint8_t *ikm, size_t ikm_size, const uint8_t *salt,
                       size_t salt_size, const uint8_t *info, size_t info_size,
                       uint8_t *okm, size_t okm_size);
...
void stedy_hmac_sha256(const uint8_t *key, size_t key_size,
                       const uint8_t *message, size_t message_size,
                       uint8_t code[32]);

bool stedy_hmac_sha256_verify(const uint8_t *key, size_t key_size,
                              const uint8_t *message, size_t message_size,
                              const uint8_t code[32]);
...
void stedy_hmac_sha512(const uint8_t *key, size_t key_size,
                       const uint8_t *message, size_t message_size,
                       uint8_t code[64]);

bool stedy_hmac_sha512_verify(const uint8_t *key, size_t key_size,
                              const uint8_t *message, size_t message_size,
                              const uint8_t code[64]);
...
void stedy_pbkdf2_hmac_sha512(const uint8_t *password, size_t password_size,
                              const uint8_t *salt, size_t salt_size,
                              size_t iterations, uint8_t *output,
                              size_t output_size);
...
void stedy_sha256(const uint8_t *message, size_t message_size,
                  uint8_t digest[32]);
...
void stedy_sha512(const uint8_t *message, size_t message_size,
                  uint8_t digest[64]);
