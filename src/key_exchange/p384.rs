...
mod tests {
    ...
    const SHARED_SECRET: [u8; 48] = [
        178, 223, 51, 152, 60, 207, 188, 90, 145, 250, 105, 101, 203, 251, 37, 219, 97, 116, 111,
        41, 81, 1, 160, 108, 158, 147, 225, 231, 172, 24, 48, 77, 206, 222, 224, 250, 182, 217,
        114, 7, 150, 130, 34, 157, 58, 210, 170, 74,
    ];
