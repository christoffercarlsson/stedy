...
mod tests {
    ...
    fn test_hkdf_sha512() {
        ...
        let expected = [
            ...
            106, 26, 22, 237, 52, 217, 252, 127, 233, 44, 20, 129, 87, 147, 56, 218, 54, 44, 184,
            217, 249, 37, 215, 203,
        ];
    ...
    fn test_hkdf_sha512_no_salt() {
        ...
        let expected = [
            245, 250, 2, 177, 130, 152, 167, 42, 140, 35, 137, 138, 135, 3, 71, 44, 110, 177, 121,
            220, 32, 76, 3, 66, 92, 151, 14, 59, 22, 75, 249, 15, 255, 34, 208, 72, 54, 208, 226,
            52, 59, 172,
        ];
