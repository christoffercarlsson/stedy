...
describe('encrypt', () => {
  ...
  const ciphers = [
    ...
    },
    {
      ...
      ciphertext: Bytes.from([3, 97, 43, 249, 197, 124, 46, 247, 57, 34, 204])
    },
    {
      cipher: 'AES-256-GCM',
      key: Bytes.from([
    ...
    },
    {
      ...
      nonce: Bytes.from([219, 45, 62, 208, 201, 18, 57, 1, 200, 223, 7, 137]),
      ciphertext: Bytes.from([
        191, 50, 127, 155, 145, 81, 79, 85, 220, 167, 73, 164, 136, 72, 105, 33,
        210, 189, 91, 100, 175, 36, 33, 47, 63, 52, 28
      ]),
      associatedData: Bytes.from([1, 2, 3, 4])
    }
  ]
