...
describe('decode', () => {
  it('should decode Base 32 encoded chunks correctly', () => {
    ...
    ).toEqual(Bytes.from([102, 111, 111, 98, 97, 114]))
  })
  ...
  it('should decode hexadecimal chunks correctly', () => {
    ...
    ).toEqual(Bytes.from([72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100]))
  })
  ...
  it('should handle invalid encodings gracefully', () => {
    expect(
      Bytes.from([72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100]).decode(
        'hubba'
      )
    ).toEqual(Bytes.from([]))
  })
